...
<section class="text-center py-32 bg-gradient-to-r from-orange-500 via-purple-500 to-blue-600 text-white">
  <h2 class="text-5xl font-extrabold">
    Hi, I'm <span class="text-yellow-300">Akash Jagdale</span>
  </h2>
  <p class="text-xl mt-4">
    I'm a Passionate Developer Creating Modern Web Experiences
  </p>
  <a href="#" class="mt-8 inline-block bg-white text-black px-8 py-3 rounded-full shadow-lg text-lg font-semibold hover:bg-gray-100">
    Hire Me
  </a>
</section>
